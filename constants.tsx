...
export const SOCIAL_LINKS = [
  { label: "Instagram", url: "https://www.instagram.com/rccg.c3tc/", icon: "Instagram" },
  { label: "Twitter", url: "https://x.com/LTC_RCCG", icon: "Twitter" },
  { label: "Facebook", url: "https://www.facebook.com/profile.php?id=61556880640052", icon: "Facebook" },
...
export const VOLUNTEER_DEPARTMENTS = [
  "Medical", "Counselling", "Protocol/Ushering", "Prayer", "Sanitation", "Welfare", "Registration", "Technical"
];
...
export const REGIONS_AND_PROVINCES: Record<string, string[]> = {
  ...
  "Region 2": [
    ...
    "Lagos Province 56", "Lagos Province 87", "Lagos Province 95", "Lagos Province 111", "Lagos Province 125"
  ],
  "Region 11": [
  ...
  "Region 19": [
    ...
    "Lagos Province 92", "Lagos Province 115", "Lagos Province 118", "Lagos Province 126",
    "Lagos Province 127"
  ],
  "Region 20": [
  ...
  "Region 54": [
    ...
    "Lagos Province 61", "Lagos Province 81", "Lagos Province 116", "Lagos Province 117",
    "Lagos Province 130"
  ],
  "Region 59": [
