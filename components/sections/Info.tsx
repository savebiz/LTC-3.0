...
const Info: React.FC = () => {
    ...
    return (
        <section className="py-20 md:py-32 px-4 relative bg-[#061102] overflow-hidden">
            {/* Colorful Background Blurs */}
            <div className="absolute top-0 left-[20%] w-[500px] h-[500px] rounded-full bg-lime-900/10 blur-[100px] pointer-events-none mix-blend-screen" />
            <div className="absolute bottom-0 right-[20%] w-[500px] h-[500px] rounded-full bg-green-900/10 blur-[100px] pointer-events-none mix-blend-screen" />
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-[#061102] via-transparent to-[#061102] pointer-events-none" />
